...
import styles from "../../src/styles/seajsws-component.css";
import RenderFriend from "./render-friend";
import GuestList from "./guest-list";

export default class seajswsComponent extends Component {
  ...
  houseParty(invitees, party) {
    return party
      ? `${styles.seajswsComponent} ${styles.house}`
      : styles.house;
  }
...
seajswsComponent.displayName = "Seajsws Component";
